    ...
    <div className="min-h-screen flex items-center justify-center bg-white font-sans selection:bg-[#246dff] selection:text-white">
      <div className="w-full max-w-[400px] px-6">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 tracking-tight mb-2">Your AI workspace.</h1>
          <p className="text-gray-500 font-medium">Log in to your NexBill account</p>
        </div>
        ...
        <div className="mt-8 pt-8 text-center space-y-4">
          ...
          <div className="flex justify-center gap-4 text-xs font-medium text-gray-500 pt-4">
            <Link to="/register" className="hover:text-gray-900 transition-colors">Sign up for an account</Link>
          </div>
        </div>
      </div>
    </div>
