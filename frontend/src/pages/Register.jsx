    ...
    <div className="min-h-screen flex font-sans selection:bg-[#246dff] selection:text-white">
      ...
      <div className="hidden lg:flex w-1/2 bg-white/40 dark:bg-black/30 backdrop-blur-xl flex-col justify-between p-12 relative overflow-hidden border-r border-white/50 dark:border-white/10">
        ...
        <div className="relative z-10 text-gray-900 dark:text-white">
          <h2 className="text-5xl font-bold mb-6 leading-tight">Build the future<br />of your business.</h2>
          <p className="text-gray-500 dark:text-gray-400 text-lg max-w-md">Join thousands of companies seamlessly managing their subscriptions with our industry-leading platform.</p>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-white/60 dark:bg-black/50 backdrop-blur-2xl relative">
        ...
        <div className="w-full max-w-[400px] px-6">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white tracking-tight mb-2">Create your workspace.</h1>
          ...
          {step === 1 ? (
            ...
            <div className="animate-in fade-in slide-in-from-right-4 duration-300">
              ...
              <form onSubmit={handleRegister} className="space-y-5">
                ...
                <ActionButton type="submit" variant="default" label="Sign up" className="w-full py-2 min-h-[38px]" />
              </form>
            </div>
          )}
          ...
          <div className="mt-8 pt-8 text-center space-y-4">
            ...
            <div className="flex justify-center gap-4 text-xs font-medium text-gray-500 dark:text-gray-400 pt-4">
              <Link to="/login" className="hover:text-gray-900 dark:hover:text-white transition-colors">Already have an account? Sign in</Link>
            </div>
          </div>
        </div>
      </div>
