...
export default function MerchantDrawer({ isOpen, onClose, ...inspectorProps }) {
  ...
  return (
    <div className="fixed inset-0 z-[100]">
      ...
      />
      {/* Drawer Panel */}
      <div className="absolute top-0 right-0 h-full w-full max-w-[540px] bg-[#f8f9fc] dark:bg-[#0e0f13] border-l border-zinc-200 dark:border-zinc-800 shadow-2xl flex flex-col drawer-enter">
        {/* Drawer Header */}
        <div className="flex items-center justify-between px-6 h-14 border-b border-zinc-200 dark:border-zinc-800/80 bg-white dark:bg-[#111113] flex-shrink-0">
